...
/** Inner half-size of the playable square (robot stays inside the walls). */
const BOARD_INNER_HALF = 8;

/** Robot proportions (walls match height + body depth). */
...
/** Keep robot body roughly inside bounds (half-width of footprint). */
